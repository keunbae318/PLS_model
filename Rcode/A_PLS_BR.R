...
a <- as.data.frame(plot(PLS_flux.model, ncomp = 4, asp = 1, line = TRUE))
b <- as.data.frame(predict(PLS_flux.model,ncomp = 4, newdata =PLSsubset.dat$spc))
a$predicted2 <- b$`flux.4 comps`
...
plot(PLS_flux.model, plottype = "coef", ncomp=1:4, legendpos = "bottomleft",
